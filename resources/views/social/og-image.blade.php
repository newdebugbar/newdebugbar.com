...
<head>
    ...
    <title>The New Debug Bar social preview</title>
...
<body class="bg-[#07070a] font-sans antialiased">
    ...
    >
        ...
        <div class="absolute top-[270px] left-[72px] z-10 w-[1050px] [transform-origin:56%_0%] [transform:perspective(1100px)_rotateX(8deg)_rotateY(-5deg)_rotateZ(-2.6deg)] [transform-style:preserve-3d]">
            <div
                class="absolute inset-0 translate-x-[11px] translate-y-[15px] rounded-[23px] bg-[linear-gradient(145deg,#5b21b6_0%,#211534_46%,#08080c_100%)] opacity-70 [box-shadow:-20px_52px_100px_rgb(0_0_0_/_88%),0_0_96px_rgb(124_58_237_/_45%)] blur-[14px]"
                aria-hidden="true"
            ></div>
