...
<html lang="en" data-theme="dark" class="bg-[#07070a]">
    ...
    <body class="bg-[#07070a] font-sans antialiased">
        ...
        >
            ...
            <h1 class="absolute top-16 left-20 z-10 m-0 w-[1040px] text-[76px] leading-[0.95] [font-weight:650] tracking-[-0.052em] text-zinc-50">
                Debug Laravel<br>
                without the <span class="text-violet-300 [text-shadow:0_0_38px_rgb(124_58_237_/_30%)]">guesswork.</span>
            </h1>

            <p class="absolute top-[239px] left-[84px] z-10 m-0 w-[1000px] text-[26px] leading-[1.35] [font-weight:450] tracking-[-0.018em] text-zinc-300">
                See what happened. Give your coding agent the same evidence.
            </p>

            <div class="absolute top-[350px] left-[72px] z-10 w-[1056px] origin-top rounded-[21px] bg-[linear-gradient(104deg,rgb(255_255_255_/_32%),rgb(196_181_253_/_62%)_44%,rgb(255_255_255_/_14%))] p-0.5 [box-shadow:0_38px_84px_rgb(0_0_0_/_74%),0_0_62px_rgb(124_58_237_/_29%)] [transform:perspective(1600px)_rotateX(2deg)_rotateZ(-1.05deg)]">
