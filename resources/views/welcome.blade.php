...
<x-layouts.site
    title="The New Debug Bar — Laravel debugging for developers and agents"
        ...
        >
            <div class="relative z-10 flex w-full min-w-0 flex-col items-center text-center">
                ...
                <p class="mt-5 max-w-[56rem] text-base leading-7 text-zinc-600 sm:mt-6 sm:text-lg sm:leading-8 lg:text-xl lg:leading-9 dark:text-zinc-400">
                    Find bugs and bottlenecks without digging through scattered logs. Inspect anything in one
                    place—while MCP gives your agent exact context with less guessing and fewer tokens.
                </p>

                <div
                    class="mt-6 inline-flex max-w-full items-center gap-[1.375rem] rounded-full border border-zinc-950/[0.08] bg-white/65 px-[1.3125rem] py-3 shadow-[0_0.75rem_2.5rem_rgb(24_24_27/0.08)] backdrop-blur-xl sm:mt-7 sm:py-4 dark:border-white/10 dark:bg-white/[0.06] dark:shadow-[0_0.75rem_2.5rem_rgb(0_0_0/0.28)]"
                    data-copy-root
                >
                    <span class="flex min-w-0 items-center gap-3">
                        <span
                            class="shrink-0 font-mono text-base leading-5 text-violet-600 sm:text-lg sm:leading-6 dark:text-violet-400"
                            aria-hidden="true"
                        >$</span>
                ...
                <div
                    class="mt-6 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 sm:mt-8"
                    aria-labelledby="sponsors-title"
                >
                    <h2
                        id="sponsors-title"
                        class="text-[0.6875rem] font-semibold tracking-[0.2em] text-zinc-500 uppercase dark:text-zinc-500"
                    >
                        Supported by
                    </h2>
                    ...
                    <ul class="flex flex-wrap items-center justify-center gap-2 sm:gap-3" role="list">
                        ...
                        <li
                            class="hidden h-7 w-px bg-zinc-200 min-[23rem]:block dark:bg-white/10"
                            aria-hidden="true"
                        ></li>
                        <li>
                            <a
                ...
                <p class="mt-4 text-sm leading-6 font-medium text-zinc-700 sm:mt-5 dark:text-zinc-300">
