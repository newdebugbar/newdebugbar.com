@props([
    ...
    'ogDescription' => null,
    'socialImage' => null,
    'socialImageAlt' => 'The New Debug Bar for Laravel showing a captured request from start to finish',
    'structuredData' => null,
])
...
<head>
    ...
    <meta property="og:site_name" content="The New Debug Bar" />
    ...
    <script
        ...
        data-website-id="d8ec6a0d-753a-41cc-9412-b5f28409c6c6"
    ></script>
</head>
<body class="[&_a]:[-webkit-tap-highlight-color:transparent] [&_button]:[-webkit-tap-highlight-color:transparent] min-h-screen bg-zinc-50 text-zinc-950 antialiased transition-colors duration-300 dark:bg-[#07070a] dark:text-white">
