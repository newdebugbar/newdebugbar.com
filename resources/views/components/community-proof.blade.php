...
@if ($downloads !== null || $stars !== null || $contributors !== [])
    <div class="mt-5 flex max-w-full flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm text-zinc-600 max-[22rem]:text-[0.8125rem] sm:mt-6 sm:gap-x-6 dark:text-zinc-400" data-community-proof>
            ...
            <div class="flex items-center gap-4 max-[22rem]:gap-3 sm:gap-6">
                @if ($downloads !== null)
                    ...
                    >
                        ...
                        <span><strong class="font-semibold text-zinc-950 dark:text-white">{{ strtolower(Number::abbreviate($downloads, maxPrecision: 1)) }}</strong> downloads</span>
                    </a>
                @endif
                ...
                @if ($stars !== null)
                    ...
                    >
                        ...
                        <span><strong class="font-semibold text-zinc-950 dark:text-white">{{ strtolower(Number::abbreviate($stars, maxPrecision: 1)) }}</strong> GitHub stars</span>
                    </a>
                @endif
            </div>
        @endif
        ...
        @if ($contributors !== [])
            ...
            >
                @foreach ($contributors as $contributor)
                    <li class="relative hover:z-10 focus-within:z-10">
                        <a
