...
The Laravel scheduler runs this command hourly. Homepage visits also refresh data
older than one hour or missing data after sending the response, so a queue worker is not required.
