...
class WebsiteFoundationTest extends TestCase
{
    public function test_the_landing_page_introduces_the_product(): void
    {
        ...
        $this->get('/')
            ...
            ->assertSee('https://github.com/newdebugbar/newdebugbar/issues', false)
            ->assertSee('Built by')
            ->assertSee('https://github.com/benjamincrozat', false)
            ->assertSee('Apache License 2.0')
            ->assertSee('https://github.com/newdebugbar/newdebugbar/blob/main/LICENSE', false)
